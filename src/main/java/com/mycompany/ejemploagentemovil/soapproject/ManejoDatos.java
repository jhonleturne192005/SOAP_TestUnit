...
{
    private static String insertar = "insert into persona (nombre,apellido,cedula,correo,estado) values (?,?,?,?,?) returning idpersona,nombre,apellido,cedula,correo,estado";
